...
export const ERROR_MESSAGES = {
  ...
  STORE_SUSPENDED:
    'ร้านค้านี้ถูกระงับชั่วคราว กรุณาส่งคำขอเปิดใช้งานใหม่หรือติดต่อฝ่ายสนับสนุน',
...
const ERROR_CATALOG_BASE: Array<{ code: ErrorMessageCode; message: string; group: string }> = [
  ...
  { code: 'INTERNAL_SERVER_ERROR', message: ERROR_MESSAGES.INTERNAL_SERVER_ERROR, group: 'ทั่วไป / ระบบ' },
  ...
  { code: 'RATE_LIMIT_EXCEEDED', message: ERROR_MESSAGES.RATE_LIMIT_EXCEEDED, group: 'ทั่วไป / ระบบ' },
  { code: 'STORAGE_NOT_CONFIGURED', message: ERROR_MESSAGES.STORAGE_NOT_CONFIGURED, group: 'ทั่วไป / ระบบ' },
  ...
  { code: 'SMS_NOT_CONFIGURED', message: ERROR_MESSAGES.SMS_NOT_CONFIGURED, group: 'ทั่วไป / ระบบ' },
  { code: 'SMS_DELIVERY_FAILED', message: ERROR_MESSAGES.SMS_DELIVERY_FAILED, group: 'ทั่วไป / ระบบ' },
  { code: 'STOREFRONT_URL_NOT_CONFIGURED', message: ERROR_MESSAGES.STOREFRONT_URL_NOT_CONFIGURED, group: 'ทั่วไป / ระบบ' },
  { code: 'UNAUTHENTICATED', message: ERROR_MESSAGES.UNAUTHENTICATED, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'UNAUTHORIZED', message: ERROR_MESSAGES.UNAUTHORIZED, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'SESSION_EXPIRED', message: ERROR_MESSAGES.SESSION_EXPIRED, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'INVALID_CREDENTIALS', message: ERROR_MESSAGES.INVALID_CREDENTIALS, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'INVALID_PASSWORD', message: ERROR_MESSAGES.INVALID_PASSWORD, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'INVALID_OTP', message: ERROR_MESSAGES.INVALID_OTP, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'INVALID_TOKEN', message: ERROR_MESSAGES.INVALID_TOKEN, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'TOKEN_EXPIRED', message: ERROR_MESSAGES.TOKEN_EXPIRED, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'INVALID_REFRESH_TOKEN', message: ERROR_MESSAGES.INVALID_REFRESH_TOKEN, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'INVALID_REACTIVATION_TOKEN', message: ERROR_MESSAGES.INVALID_REACTIVATION_TOKEN, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'TOO_MANY_ATTEMPTS', message: ERROR_MESSAGES.TOO_MANY_ATTEMPTS, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'ACCOUNT_SUSPENDED', message: ERROR_MESSAGES.ACCOUNT_SUSPENDED, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'CUSTOMER_SUSPENDED', message: ERROR_MESSAGES.CUSTOMER_SUSPENDED, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'CUSTOMER_PENDING_DELETION', message: ERROR_MESSAGES.CUSTOMER_PENDING_DELETION, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'FORBIDDEN', message: ERROR_MESSAGES.FORBIDDEN, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'STORE_MANAGER_REQUIRED', message: ERROR_MESSAGES.STORE_MANAGER_REQUIRED, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'STORE_OWNER_REQUIRED', message: ERROR_MESSAGES.STORE_OWNER_REQUIRED, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'STORE_ACCESS_DENIED', message: ERROR_MESSAGES.STORE_ACCESS_DENIED, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'INVALID_ROLE', message: ERROR_MESSAGES.INVALID_ROLE, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'CANNOT_CHANGE_OWNER', message: ERROR_MESSAGES.CANNOT_CHANGE_OWNER, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'CANNOT_REMOVE_OWNER', message: ERROR_MESSAGES.CANNOT_REMOVE_OWNER, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'INVALID_API_KEY', message: ERROR_MESSAGES.INVALID_API_KEY, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'API_KEY_NOT_FOUND', message: ERROR_MESSAGES.API_KEY_NOT_FOUND, group: 'การยืนยันตัวตน / สิทธิ์' },
  { code: 'CART_IDENTITY_REQUIRED', message: ERROR_MESSAGES.CART_IDENTITY_REQUIRED, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'CART_ITEM_NOT_FOUND', message: ERROR_MESSAGES.CART_ITEM_NOT_FOUND, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'INSUFFICIENT_STOCK', message: ERROR_MESSAGES.INSUFFICIENT_STOCK, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'VARIANT_NOT_FOUND', message: ERROR_MESSAGES.VARIANT_NOT_FOUND, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'VARIANT_REQUIRED', message: ERROR_MESSAGES.VARIANT_REQUIRED, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'GUEST_PHONE_REQUIRED', message: ERROR_MESSAGES.GUEST_PHONE_REQUIRED, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'SHIPPING_ADDRESS_REQUIRED', message: ERROR_MESSAGES.SHIPPING_ADDRESS_REQUIRED, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'INVALID_SHIPPING_ADDRESS', message: ERROR_MESSAGES.INVALID_SHIPPING_ADDRESS, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'SHIPPING_OPTION_REQUIRED', message: ERROR_MESSAGES.SHIPPING_OPTION_REQUIRED, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'INVALID_SHIPPING_OPTION', message: ERROR_MESSAGES.INVALID_SHIPPING_OPTION, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'SAVED_ADDRESS_NOT_FOUND', message: ERROR_MESSAGES.SAVED_ADDRESS_NOT_FOUND, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'SAVED_ADDRESS_REQUIRES_LOGIN', message: ERROR_MESSAGES.SAVED_ADDRESS_REQUIRES_LOGIN, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'ORDER_CONTAINS_SUSPENDED_STORE', message: ERROR_MESSAGES.ORDER_CONTAINS_SUSPENDED_STORE, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'SUSPENDED_STORE_ITEM_REMOVED', message: ERROR_MESSAGES.SUSPENDED_STORE_ITEM_REMOVED, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'MISSING_LINES', message: ERROR_MESSAGES.MISSING_LINES, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'QUANTITY_TOO_LARGE', message: ERROR_MESSAGES.QUANTITY_TOO_LARGE, group: 'ตะกร้า / เช็คเอาต์' },
  { code: 'ORDER_NOT_FOUND', message: ERROR_MESSAGES.ORDER_NOT_FOUND, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'ORDER_NOT_PAYABLE', message: ERROR_MESSAGES.ORDER_NOT_PAYABLE, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'ORDER_ALREADY_CANCELLED', message: ERROR_MESSAGES.ORDER_ALREADY_CANCELLED, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'ORDER_NOT_FULLY_SHIPPED', message: ERROR_MESSAGES.ORDER_NOT_FULLY_SHIPPED, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'ORDER_NOT_REVIEWABLE', message: ERROR_MESSAGES.ORDER_NOT_REVIEWABLE, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'INVALID_ORDER_STATUS', message: ERROR_MESSAGES.INVALID_ORDER_STATUS, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'MULTI_VENDOR_ORDER', message: ERROR_MESSAGES.MULTI_VENDOR_ORDER, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'HOLD_TRANSITION_FORBIDDEN', message: ERROR_MESSAGES.HOLD_TRANSITION_FORBIDDEN, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'HOLD_CANCEL_FORBIDDEN', message: ERROR_MESSAGES.HOLD_CANCEL_FORBIDDEN, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'HOLD_RESTORE_SNAPSHOT_MISSING', message: ERROR_MESSAGES.HOLD_RESTORE_SNAPSHOT_MISSING, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'BANK_TRANSFER_ADMIN_ONLY', message: ERROR_MESSAGES.BANK_TRANSFER_ADMIN_ONLY, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'BANK_TRANSFER_NOT_CONFIGURED', message: ERROR_MESSAGES.BANK_TRANSFER_NOT_CONFIGURED, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'BANK_TRANSFER_FIELD_REQUIRED', message: ERROR_MESSAGES.BANK_TRANSFER_FIELD_REQUIRED, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'BANK_TRANSFER_FIELD_TOO_LONG', message: ERROR_MESSAGES.BANK_TRANSFER_FIELD_TOO_LONG, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'NOT_BANK_TRANSFER', message: ERROR_MESSAGES.NOT_BANK_TRANSFER, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'USE_CONFIRM_BANK_TRANSFER', message: ERROR_MESSAGES.USE_CONFIRM_BANK_TRANSFER, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'PAYMENT_NOT_FOUND', message: ERROR_MESSAGES.PAYMENT_NOT_FOUND, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'PAYMENT_NOT_CONFIRMABLE', message: ERROR_MESSAGES.PAYMENT_NOT_CONFIRMABLE, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'PAYMENT_HELD_PORTION_BLOCKED', message: ERROR_MESSAGES.PAYMENT_HELD_PORTION_BLOCKED, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'PAYMENT_METHOD_NOT_FOUND', message: ERROR_MESSAGES.PAYMENT_METHOD_NOT_FOUND, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'PAYMENT_METHOD_ALREADY_EXISTS', message: ERROR_MESSAGES.PAYMENT_METHOD_ALREADY_EXISTS, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'PAYMENT_SUBSCRIPTION_TARGET_REQUIRED', message: ERROR_MESSAGES.PAYMENT_SUBSCRIPTION_TARGET_REQUIRED, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'CARD_TOKEN_REQUIRED', message: ERROR_MESSAGES.CARD_TOKEN_REQUIRED, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'CUSTOMER_REQUIRED', message: ERROR_MESSAGES.CUSTOMER_REQUIRED, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'OMISE_NOT_CONFIGURED', message: ERROR_MESSAGES.OMISE_NOT_CONFIGURED, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'OMISE_ERROR', message: ERROR_MESSAGES.OMISE_ERROR, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'OMISE_CARD_NOT_FOUND', message: ERROR_MESSAGES.OMISE_CARD_NOT_FOUND, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'OMISE_CUSTOMER_NOT_FOUND', message: ERROR_MESSAGES.OMISE_CUSTOMER_NOT_FOUND, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'OMISE_RECIPIENT_NOT_CONNECTED', message: ERROR_MESSAGES.OMISE_RECIPIENT_NOT_CONNECTED, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'OMISE_RECIPIENT_NOT_READY', message: ERROR_MESSAGES.OMISE_RECIPIENT_NOT_READY, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'OMISE_TRANSFER_FAILED', message: ERROR_MESSAGES.OMISE_TRANSFER_FAILED, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'INSUFFICIENT_BALANCE', message: ERROR_MESSAGES.INSUFFICIENT_BALANCE, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'INVALID_PAYOUT_AMOUNT', message: ERROR_MESSAGES.INVALID_PAYOUT_AMOUNT, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'PAYOUT_ALREADY_PENDING', message: ERROR_MESSAGES.PAYOUT_ALREADY_PENDING, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'PAYOUT_BELOW_MINIMUM', message: ERROR_MESSAGES.PAYOUT_BELOW_MINIMUM, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'PAYOUT_MISMATCH', message: ERROR_MESSAGES.PAYOUT_MISMATCH, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'PAYOUT_NOT_FOUND', message: ERROR_MESSAGES.PAYOUT_NOT_FOUND, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'PAYOUT_NOT_PENDING', message: ERROR_MESSAGES.PAYOUT_NOT_PENDING, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'PAYOUT_WRONG_RAIL', message: ERROR_MESSAGES.PAYOUT_WRONG_RAIL, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'NO_PENDING_MANUAL_PAYOUT', message: ERROR_MESSAGES.NO_PENDING_MANUAL_PAYOUT, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'COMMISSION_FORMULA_MISMATCH', message: ERROR_MESSAGES.COMMISSION_FORMULA_MISMATCH, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'INVALID_COMMISSION_RATE', message: ERROR_MESSAGES.INVALID_COMMISSION_RATE, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'FULFILLMENT_PROVIDER_REQUIRED', message: ERROR_MESSAGES.FULFILLMENT_PROVIDER_REQUIRED, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'FULFILLMENT_PROVIDER_TOO_LONG', message: ERROR_MESSAGES.FULFILLMENT_PROVIDER_TOO_LONG, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'INVALID_FULFILLMENT_STATE', message: ERROR_MESSAGES.INVALID_FULFILLMENT_STATE, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'NO_STORE_ITEMS', message: ERROR_MESSAGES.NO_STORE_ITEMS, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'TRACKING_NUMBER_REQUIRED', message: ERROR_MESSAGES.TRACKING_NUMBER_REQUIRED, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'TRACKING_NUMBER_TOO_LONG', message: ERROR_MESSAGES.TRACKING_NUMBER_TOO_LONG, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'TRACKING_URL_REQUIRED', message: ERROR_MESSAGES.TRACKING_URL_REQUIRED, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'TRACKING_URL_INVALID', message: ERROR_MESSAGES.TRACKING_URL_INVALID, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'TRACKING_URL_INSECURE', message: ERROR_MESSAGES.TRACKING_URL_INSECURE, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'TRACKING_URL_TOO_LONG', message: ERROR_MESSAGES.TRACKING_URL_TOO_LONG, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'INVALID_AUDIT_EVENT', message: ERROR_MESSAGES.INVALID_AUDIT_EVENT, group: 'คำสั่งซื้อ / การชำระเงิน / โอนเงิน' },
  { code: 'INVALID_PROMOTION', message: ERROR_MESSAGES.INVALID_PROMOTION, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'PROMOTION_NOT_FOUND', message: ERROR_MESSAGES.PROMOTION_NOT_FOUND, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'PROMOTION_EXPIRED', message: ERROR_MESSAGES.PROMOTION_EXPIRED, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'PROMOTION_NOT_STARTED', message: ERROR_MESSAGES.PROMOTION_NOT_STARTED, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'PROMOTION_LIMIT', message: ERROR_MESSAGES.PROMOTION_LIMIT, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'PROMOTION_CUSTOMER_LIMIT', message: ERROR_MESSAGES.PROMOTION_CUSTOMER_LIMIT, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'PROMOTION_MIN_PURCHASE', message: ERROR_MESSAGES.PROMOTION_MIN_PURCHASE, group: 'โปรโมชัน / แคมเปญ' },
  ...
  { code: 'INVALID_PROMOTION_DATE_RANGE', message: ERROR_MESSAGES.INVALID_PROMOTION_DATE_RANGE, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'INVALID_VALIDATE_PROMOTIONS_INPUT', message: ERROR_MESSAGES.INVALID_VALIDATE_PROMOTIONS_INPUT, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'INVALID_CONDITIONS', message: ERROR_MESSAGES.INVALID_CONDITIONS, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'INVALID_BXGY_CONDITIONS', message: ERROR_MESSAGES.INVALID_BXGY_CONDITIONS, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'INVALID_DISCOUNT_VALUE', message: ERROR_MESSAGES.INVALID_DISCOUNT_VALUE, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'INVALID_LOGGED_IN_ONLY_CONDITIONS', message: ERROR_MESSAGES.INVALID_LOGGED_IN_ONLY_CONDITIONS, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'INVALID_NEW_CUSTOMER_CONDITIONS', message: ERROR_MESSAGES.INVALID_NEW_CUSTOMER_CONDITIONS, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'SALE_CAMPAIGN_NOT_FOUND', message: ERROR_MESSAGES.SALE_CAMPAIGN_NOT_FOUND, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'INVALID_SALE_CAMPAIGN_DATE_RANGE', message: ERROR_MESSAGES.INVALID_SALE_CAMPAIGN_DATE_RANGE, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'SALE_CAMPAIGN_ITEM_DISCOUNT_REQUIRED', message: ERROR_MESSAGES.SALE_CAMPAIGN_ITEM_DISCOUNT_REQUIRED, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'SALE_CAMPAIGN_COMPARE_AT_INVALID', message: ERROR_MESSAGES.SALE_CAMPAIGN_COMPARE_AT_INVALID, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'PRODUCT_NOT_IN_STORE', message: ERROR_MESSAGES.PRODUCT_NOT_IN_STORE, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'VARIANT_NOT_ON_PRODUCT', message: ERROR_MESSAGES.VARIANT_NOT_ON_PRODUCT, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'PRODUCT_STORE_MISMATCH', message: ERROR_MESSAGES.PRODUCT_STORE_MISMATCH, group: 'โปรโมชัน / แคมเปญ' },
  { code: 'PRODUCT_NOT_FOUND', message: ERROR_MESSAGES.PRODUCT_NOT_FOUND, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'PRODUCT_NOT_PUBLISHABLE', message: ERROR_MESSAGES.PRODUCT_NOT_PUBLISHABLE, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'PRODUCT_NOT_IN_ORDER', message: ERROR_MESSAGES.PRODUCT_NOT_IN_ORDER, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'SKU_EXISTS', message: ERROR_MESSAGES.SKU_EXISTS, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'VARIANTS_REQUIRED', message: ERROR_MESSAGES.VARIANTS_REQUIRED, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'VARIANT_ITEMS_REQUIRED', message: ERROR_MESSAGES.VARIANT_ITEMS_REQUIRED, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'INVALID_VARIANT_OPTIONS', message: ERROR_MESSAGES.INVALID_VARIANT_OPTIONS, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'DUPLICATE_VARIANT_GROUP', message: ERROR_MESSAGES.DUPLICATE_VARIANT_GROUP, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'DUPLICATE_VARIANT_COMBINATION', message: ERROR_MESSAGES.DUPLICATE_VARIANT_COMBINATION, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'VARIANT_REMOVAL_BLOCKED', message: ERROR_MESSAGES.VARIANT_REMOVAL_BLOCKED, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'IMAGE_NOT_FOUND', message: ERROR_MESSAGES.IMAGE_NOT_FOUND, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'TOO_MANY_IMAGES', message: ERROR_MESSAGES.TOO_MANY_IMAGES, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'IMAGE_TOO_LARGE', message: ERROR_MESSAGES.IMAGE_TOO_LARGE, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'INVALID_IMAGE', message: ERROR_MESSAGES.INVALID_IMAGE, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'INVALID_IMAGE_TYPE', message: ERROR_MESSAGES.INVALID_IMAGE_TYPE, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'INVALID_IMAGE_URL', message: ERROR_MESSAGES.INVALID_IMAGE_URL, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'INVALID_ASPECT_RATIO', message: ERROR_MESSAGES.INVALID_ASPECT_RATIO, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'INVALID_CATEGORY_IMAGE_URL', message: ERROR_MESSAGES.INVALID_CATEGORY_IMAGE_URL, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'CATEGORY_NOT_FOUND', message: ERROR_MESSAGES.CATEGORY_NOT_FOUND, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'CATEGORY_NOT_APPROVED', message: ERROR_MESSAGES.CATEGORY_NOT_APPROVED, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'CATEGORY_IMAGE_REQUIRED', message: ERROR_MESSAGES.CATEGORY_IMAGE_REQUIRED, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'CATEGORY_REPLACEMENT_REQUIRED', message: ERROR_MESSAGES.CATEGORY_REPLACEMENT_REQUIRED, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'CATEGORY_REPLACEMENT_INVALID', message: ERROR_MESSAGES.CATEGORY_REPLACEMENT_INVALID, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'CATEGORY_HAS_PRODUCTS', message: ERROR_MESSAGES.CATEGORY_HAS_PRODUCTS, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'INVALID_REPLACEMENT_CATEGORY', message: ERROR_MESSAGES.INVALID_REPLACEMENT_CATEGORY, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'TAG_NOT_FOUND', message: ERROR_MESSAGES.TAG_NOT_FOUND, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'TAG_NOT_APPROVED', message: ERROR_MESSAGES.TAG_NOT_APPROVED, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'BRAND_NOT_FOUND', message: ERROR_MESSAGES.BRAND_NOT_FOUND, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'BRAND_NOT_APPROVED', message: ERROR_MESSAGES.BRAND_NOT_APPROVED, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'PET_TYPE_NOT_FOUND', message: ERROR_MESSAGES.PET_TYPE_NOT_FOUND, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'PET_TYPE_NOT_APPROVED', message: ERROR_MESSAGES.PET_TYPE_NOT_APPROVED, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'DUPLICATE_NAME', message: ERROR_MESSAGES.DUPLICATE_NAME, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  ...
  { code: 'ALREADY_FAVORITED', message: ERROR_MESSAGES.ALREADY_FAVORITED, group: 'แคตตาล็อก / อนุกรมวิธาน' },
  { code: 'USER_NOT_FOUND', message: ERROR_MESSAGES.USER_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'VENDOR_NOT_FOUND', message: ERROR_MESSAGES.VENDOR_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'ADMIN_NOT_FOUND', message: ERROR_MESSAGES.ADMIN_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'CUSTOMER_NOT_FOUND', message: ERROR_MESSAGES.CUSTOMER_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  ...
  { code: 'EMAIL_NOT_VERIFIED', message: ERROR_MESSAGES.EMAIL_NOT_VERIFIED, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'EMAIL_ALREADY_VERIFIED', message: ERROR_MESSAGES.EMAIL_ALREADY_VERIFIED, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'PHONE_ALREADY_EXISTS', message: ERROR_MESSAGES.PHONE_ALREADY_EXISTS, group: 'บัญชี / ร้าน / ทีม' },
  ...
  { code: 'ADDRESS_NOT_FOUND', message: ERROR_MESSAGES.ADDRESS_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'INVALID_DATE_OF_BIRTH', message: ERROR_MESSAGES.INVALID_DATE_OF_BIRTH, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'ACCOUNT_NOT_PENDING_DELETION', message: ERROR_MESSAGES.ACCOUNT_NOT_PENDING_DELETION, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'DELETION_ALREADY_REQUESTED', message: ERROR_MESSAGES.DELETION_ALREADY_REQUESTED, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'DELETION_RETENTION_EXPIRED', message: ERROR_MESSAGES.DELETION_RETENTION_EXPIRED, group: 'บัญชี / ร้าน / ทีม' },
  ...
  { code: 'STORE_NOT_SUSPENDED', message: ERROR_MESSAGES.STORE_NOT_SUSPENDED, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'NO_ACTIVE_STORE', message: ERROR_MESSAGES.NO_ACTIVE_STORE, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'NO_STORE_SELECTED', message: ERROR_MESSAGES.NO_STORE_SELECTED, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'STORE_CONTEXT_REQUIRED', message: ERROR_MESSAGES.STORE_CONTEXT_REQUIRED, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'STORE_ID_REQUIRED', message: ERROR_MESSAGES.STORE_ID_REQUIRED, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'OWNER_REQUIRED', message: ERROR_MESSAGES.OWNER_REQUIRED, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'PENDING_REQUEST_EXISTS', message: ERROR_MESSAGES.PENDING_REQUEST_EXISTS, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'STORE_REQUEST_NOT_FOUND', message: ERROR_MESSAGES.STORE_REQUEST_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'PENDING_REACTIVATION_REQUEST_EXISTS', message: ERROR_MESSAGES.PENDING_REACTIVATION_REQUEST_EXISTS, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'REACTIVATION_REQUEST_NOT_FOUND', message: ERROR_MESSAGES.REACTIVATION_REQUEST_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  ...
  { code: 'MEMBER_NOT_FOUND', message: ERROR_MESSAGES.MEMBER_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'INVITATION_EXISTS', message: ERROR_MESSAGES.INVITATION_EXISTS, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'INVITATION_EXPIRED', message: ERROR_MESSAGES.INVITATION_EXPIRED, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'INVITATION_INVALID', message: ERROR_MESSAGES.INVITATION_INVALID, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'INVITATION_NOT_FOUND', message: ERROR_MESSAGES.INVITATION_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'INVITATION_NOT_PENDING', message: ERROR_MESSAGES.INVITATION_NOT_PENDING, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'NOTIFICATION_NOT_FOUND', message: ERROR_MESSAGES.NOTIFICATION_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'BANNER_NOT_FOUND', message: ERROR_MESSAGES.BANNER_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'SPONSOR_NOT_FOUND', message: ERROR_MESSAGES.SPONSOR_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'AD_NOT_FOUND', message: ERROR_MESSAGES.AD_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'LOGIN_PAGE_IMAGES_DESKTOP_REQUIRED', message: ERROR_MESSAGES.LOGIN_PAGE_IMAGES_DESKTOP_REQUIRED, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'LOGIN_PAGE_IMAGES_ALT_TOO_LONG', message: ERROR_MESSAGES.LOGIN_PAGE_IMAGES_ALT_TOO_LONG, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'SHIPPING_OPTION_NOT_FOUND', message: ERROR_MESSAGES.SHIPPING_OPTION_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'SHIPPING_PROVIDER_NOT_FOUND', message: ERROR_MESSAGES.SHIPPING_PROVIDER_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'LAST_SHIPPING_OPTION', message: ERROR_MESSAGES.LAST_SHIPPING_OPTION, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'LAST_ACTIVE_SHIPPING_OPTION', message: ERROR_MESSAGES.LAST_ACTIVE_SHIPPING_OPTION, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'WEBHOOK_NOT_FOUND', message: ERROR_MESSAGES.WEBHOOK_NOT_FOUND, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'INVALID_WEBHOOK_URL', message: ERROR_MESSAGES.INVALID_WEBHOOK_URL, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'INVALID_WEBHOOK_EVENT', message: ERROR_MESSAGES.INVALID_WEBHOOK_EVENT, group: 'บัญชี / ร้าน / ทีม' },
  { code: 'EMAIL_TEMPLATE_NOT_FOUND', message: ERROR_MESSAGES.EMAIL_TEMPLATE_NOT_FOUND, group: 'อีเมล CMS / รีวิว' },
  { code: 'EMAIL_DEFAULT_CONTAINER_REQUIRED', message: ERROR_MESSAGES.EMAIL_DEFAULT_CONTAINER_REQUIRED, group: 'อีเมล CMS / รีวิว' },
  { code: 'EMAIL_CONTAINER_SLOT_INVALID', message: ERROR_MESSAGES.EMAIL_CONTAINER_SLOT_INVALID, group: 'อีเมล CMS / รีวิว' },
  { code: 'EMAIL_HTML_BLOCKED', message: ERROR_MESSAGES.EMAIL_HTML_BLOCKED, group: 'อีเมล CMS / รีวิว' },
  { code: 'EMAIL_UNKNOWN_PLACEHOLDERS', message: ERROR_MESSAGES.EMAIL_UNKNOWN_PLACEHOLDERS, group: 'อีเมล CMS / รีวิว' },
  { code: 'EMAIL_INVALID_VARIABLES_JSON', message: ERROR_MESSAGES.EMAIL_INVALID_VARIABLES_JSON, group: 'อีเมล CMS / รีวิว' },
  { code: 'EMAIL_TEST_SEND_FAILED', message: ERROR_MESSAGES.EMAIL_TEST_SEND_FAILED, group: 'อีเมล CMS / รีวิว' },
  { code: 'REVIEW_NOT_FOUND', message: ERROR_MESSAGES.REVIEW_NOT_FOUND, group: 'อีเมล CMS / รีวิว' },
  { code: 'REVIEW_ALREADY_EXISTS', message: ERROR_MESSAGES.REVIEW_ALREADY_EXISTS, group: 'อีเมล CMS / รีวิว' },
  { code: 'REVIEW_NOT_APPROVED', message: ERROR_MESSAGES.REVIEW_NOT_APPROVED, group: 'อีเมล CMS / รีวิว' },
  { code: 'REVIEW_WINDOW_EXPIRED', message: ERROR_MESSAGES.REVIEW_WINDOW_EXPIRED, group: 'อีเมล CMS / รีวิว' },
  { code: 'REVIEW_TOO_MANY_IMAGES', message: ERROR_MESSAGES.REVIEW_TOO_MANY_IMAGES, group: 'อีเมล CMS / รีวิว' },
  { code: 'INVALID_RATING', message: ERROR_MESSAGES.INVALID_RATING, group: 'อีเมล CMS / รีวิว' },
  { code: 'INVALID_REVIEW_STATUS', message: ERROR_MESSAGES.INVALID_REVIEW_STATUS, group: 'อีเมล CMS / รีวิว' },
  { code: 'REVIEW_REPLY_NOT_FOUND', message: ERROR_MESSAGES.REVIEW_REPLY_NOT_FOUND, group: 'อีเมล CMS / รีวิว' },
  { code: 'REVIEW_REPLY_ALREADY_EXISTS', message: ERROR_MESSAGES.REVIEW_REPLY_ALREADY_EXISTS, group: 'อีเมล CMS / รีวิว' },
  { code: 'REVIEW_REPLY_BODY_EMPTY', message: ERROR_MESSAGES.REVIEW_REPLY_BODY_EMPTY, group: 'อีเมล CMS / รีวิว' },
  { code: 'REVIEW_REPLY_BODY_INVALID', message: ERROR_MESSAGES.REVIEW_REPLY_BODY_INVALID, group: 'อีเมล CMS / รีวิว' },
  { code: 'REVIEW_REPLY_BODY_TOO_LONG', message: ERROR_MESSAGES.REVIEW_REPLY_BODY_TOO_LONG, group: 'อีเมล CMS / รีวิว' },
];
