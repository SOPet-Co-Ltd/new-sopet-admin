...
export const APPROVED_CATEGORIES_QUERY = gql`
  query ApprovedCategories {
    approvedCategories {
      id
      name
      slug
...
export const APPROVED_TAGS_QUERY = gql`
  query ApprovedTags {
    approvedTags {
      id
      name
...
export const PENDING_CATEGORIES_QUERY = gql`
  query PendingCategories {
    pendingCategories {
      id
      name
      slug
...
export const PENDING_TAGS_QUERY = gql`
  query PendingTags {
    pendingTags {
      id
      name
...
export const MY_CATEGORY_PROPOSALS_QUERY = gql`
  query MyCategoryProposals {
    myCategoryProposals {
      id
      name
      slug
...
export const MY_TAG_PROPOSALS_QUERY = gql`
  query MyTagProposals {
    myTagProposals {
      id
      name
      slug
...
export const APPROVE_CATEGORY = gql`
  mutation ApproveCategory($id: String!) {
    approveCategory(id: $id) {
      id
      name
      slug
      approvalStatus
...
export const REJECT_CATEGORY = gql`
  mutation RejectCategory($id: String!) {
    rejectCategory(id: $id) {
      id
      name
      slug
      approvalStatus
...
export const APPROVE_TAG = gql`
  mutation ApproveTag($id: String!) {
    approveTag(id: $id) {
      id
      name
      slug
...
export const REJECT_TAG = gql`
  mutation RejectTag($id: String!) {
    rejectTag(id: $id) {
      id
      name
      slug
